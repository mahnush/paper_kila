...
def get_in_out(i):
    ...
    #control_var = control_var[0, 450:950, :]
    #perturbed_var = perturbed_var[0, 450:950, :]
    control_var = control_var[0, :, :]
    perturbed_var = perturbed_var[0, :, :]
    ...
    per_inside_mask_1 = ma.masked_where(per_inside == 0, per_inside)
...
axs0.grid(True)
axs1.grid(True)
plt.savefig('pdf_nd_22_23_24Dec_no_legend_fig4.png')
plt.savefig('pdf_nd_22_23_24Dec_no_legend_fig4.pdf')
plt.show()